...
const Model = () => {
  ...
  useEffect(() => {
    ...
    if(size === 'large'){
      animationWithGsapTimeLine( tl, small, smallRotation , '#view1' ,{
        transform: 'translateX(-100%)', 
        duration: 2
      }, '#view2' )
    }
    if(size === 'small'){
      animationWithGsapTimeLine( tl, large, largeRotation , '#view2' ,{
  ...
  return (
    <section className="common-padding" >
      <div className="screen-max-width">
        <h1 id="heading" className="section-heading"> Take acloser look </h1>
